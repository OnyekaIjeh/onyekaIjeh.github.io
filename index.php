...
<html>
	<head>
		<title>Onyeka Ijeh - Aspiring Web Developer</title>
		<meta charset="utf-8" />
		<meta name="description" content="Onyeka Ijeh is an aspiring Web Developer based in Nigeria.">
...
<meta property="og:title" content="Onyeka Ijeh - Aspiring Web Developer based in Nigeria.">
<meta property="og:url" content="http://onyeka.name.ng">
<meta property="og:image" content="http://onyeka.name.ng/images/profile.jpg">
<meta property="profile:first_name" content="Onyeka">
<meta property="profile:last_name" content="Ijeh">


<!-- Twitter Card -->
<meta name="twitter:card" content="summary" />
<meta name="twitter:site" content="@onyekaijeh" />
<meta name="twitter:title" content="Onyeka Ijeh - Aspiring Web Developer" />
<meta name="twitter:description" content="Onyeka Ijeh is an aspiring web developer based in Nigeria." />
<meta name="twitter:image" content="http://onyeka.name.ng/images/profile.jpg" />
...
<meta name="application-name" content="Onyeka Ijeh - Aspiring Web Developer"/>
					...
					<div id="main">
						...
						<!-- About -->
							<article id="about">
								...
								<p>Hello guys, my name is Onyeka Ijeh, a graduate from the University of Benin where I studied Electrical/Electronic Engineering.</p></br>
								<p> I'm an aspiring Web Developer, focusing on backend web technologies (leaving the frontend jigi jaga for now. Not that I can't write simple HTML, CSS and Javascript though).</p></br>
...
-->
				...
				<!-- Footer -->
					<footer id="footer">
						<p class="copyright">&copy; Onyeka Ijeh. Design: <a href="https://html5up.net">HTML5 UP</a>.</p>
					</footer>
